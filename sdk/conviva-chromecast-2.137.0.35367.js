...
// namespace utils
    function Settings() {
        ...
        if(_s != STAT_INIT) _s.clientVersion /* : String */ = "2.137.0.35367";
...
function ConvivaCastV3StreamerProxy() {
  ...
  this._setAllEventListeners = function() {
    ...
    if (_s._castPlayer) {
      ...
      _s._castPlayer.addEventListener(cast.framework.events.EventType.MEDIA_FINISHED, _s.onMediaFinished);
  ...
  this._removeAllEventListeners = function() {
    ...
    if (_s._castPlayer) {
      ...
      _s._castPlayer.removeEventListener(cast.framework.events.EventType.MEDIA_FINISHED, _s.onMediaFinished);
  ...
  this.onMediaFinished = function(event, p1, p2) {
    Utils.getInstance().runProtected(function() {
      _s.Log('ConvivaCastV3StreamerProxy.onMediaFinished');
      if (_s._castPlayer) {
        _s.SetPlayerState(Conviva.ConvivaStreamerProxy.STOPPED);
      }
    }, 'ConvivaCastV3StreamerProxy.onMediaFinished');
  };
